...
set_false_path -from [get_clocks userclk1] -to [get_clocks clk_out1_clk_wiz_0]
set_false_path -from [get_clocks clk_out1_clk_wiz_0] -to [get_clocks userclk1]
set_false_path -from [get_clocks userclk1] -to [get_clocks clk_out2_clk_wiz_0]
set_false_path -from [get_clocks clk_out2_clk_wiz_0] -to [get_clocks userclk1]
set_false_path -from [get_clocks userclk1] -to [get_clocks clk_out3_clk_wiz_0]
set_false_path -from [get_clocks clk_out3_clk_wiz_0] -to [get_clocks userclk1]
